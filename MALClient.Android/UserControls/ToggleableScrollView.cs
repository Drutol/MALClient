...
{
    public class PriorityScrollView : ScrollView
    {
        ...
        public PriorityScrollView(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }

        public PriorityScrollView(Context context) : base(context)
        {
        }

        public PriorityScrollView(Context context, IAttributeSet attrs) : base(context, attrs)
        {
        }

        public PriorityScrollView(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
        }

        public PriorityScrollView(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes) : base(context, attrs, defStyleAttr, defStyleRes)
        {
        }
