            ...
            switch (tag)
            {
                case "Anime":
                    ...
                    if (_authenticatedUser)
                    {
                        ...
                        {
                            var data = await ViewModelLocator.GeneralAnimeList.TryRetrieveAuthenticatedAnimeItem(id);
                            if (data != null)
                            {
                ...
                case "Manga":
                    ...
                    if (_authenticatedUser)
                    {
                        ...
                        {
                            var data = await ViewModelLocator.GeneralAnimeList.TryRetrieveAuthenticatedAnimeItem(id, false);
                            if (data != null)
                            {
